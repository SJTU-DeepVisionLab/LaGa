...
from scene.dataset_readers_multi_lvl import sceneLoadTypeCallbacks, fetchPly
...
class Scene:
    ...
    def __init__(self, args : ModelParams, gaussians : GaussianModel=None, feature_gaussians: FeatureGaussianModel=None, load_iteration=None, feature_load_iteration=None, shuffle=True, resolution_scales=[1.0], init_from_3dgs_pcd=False, target='scene', mode='train', sample_rate = 1.0):
        ...
        # and not os.path.exists(os.path.join(args.source_path, "transforms.json")):
            ...
            scene_info = sceneLoadTypeCallbacks["Blender"](args.source_path, args.white_background, args.eval, need_features = args.need_features, need_masks = args.need_masks)
    ...
    def save_feature(self, iteration, target = 'coarse_seg_everything', smooth_weights = None, smooth_type = None, smooth_K = 16, generator = None, point_colors = None):
